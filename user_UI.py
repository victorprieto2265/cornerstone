...
program_status = input('   enter "prelim" or "playoff" => ')

while program_status not in ['prelim', 'playoff']:
...
source = f'./inputs/master_templates/{tournament_format}_{program_status}.xlsx'
destination = f'./data input/{program_status}_data.xlsx'
